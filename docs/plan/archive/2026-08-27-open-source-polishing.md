...
- [ ] `README.md`, `LICENSE`, `SECURITY.md`, all package license metadata, CODEOWNERS/governance/support files, GitHub settings, labels, and remote issues are unchanged; the six paths in the affected-files table plus this archived plan are the complete seven-path documentation diff.
